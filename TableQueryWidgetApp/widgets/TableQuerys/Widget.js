define(['dojo/_base/declare',
  ...
  function(declare, BaseWidget,Query, QueryTask, domConstruct, arrayUtils, dom, on, FeatureLayer,Graphic,PictureMarkerSymbol,SimpleLineSymbol,SimpleFillSymbol,Color,esriConfig) {
          ...
          function drawSelected(fs){
            ...
            for (i = 0; i < fs.features.length; i++) {
              ...
              if (featureSelected.geometry.type == "point" ||featureSelected.geometry.type == "multiPoint") {
                var simbologia = new PictureMarkerSymbol('http://desarrolladores.esri.es/wp-content/uploads/images/ArcGIS%20PIN%20ICON.png', 20, 35);
                simbologia.yoffset = 17;
